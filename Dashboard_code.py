# -*- coding: utf-8 -*-
"""
Created on Sun Apr 16 20:08:49 2023
...
#define function to give a style
...
def load_data():
    ...
    #change the colum values or names in this case cause some names were not right
    df_agg.columns = ['Video', 'Video title', 'Video publish time', 'Comments added','Shares', 'Dislikes',
                      'Likes', 'Subscribers lost', 'Subscribers gained', 'RPM(USD)', 'CPM (USD)', 'Average percentage viewed (%)',
...
#build dashboard
add_sidebar = st.sidebar.selectbox('Aggregate or Individual Videos', ('Aggregate Metrics', 'Individual Video Analysis'))
...
if add_sidebar == 'Aggregate Metrics':
    ...
    df_agg_diff_final = df_agg_diff.loc[:,['Video title','Video publish time','Views','Likes','Subscribers','Shares','Comments added','RPM(USD)','Average percentage viewed (%)',
                             'Avg_duration_sec', 'Engagement_ratio','Views / sub gained']]
    ...
    agg_title = df_agg[df_agg['Video title'] == video_select]
